...
import {
    ...
    GetProductNewStockByIdModel, GetProductNewStockByIdRes
 ...
 * @returns
 */
export const getProductSkuImage = (p: GetProductSkuImageMode) => httpPost<GetProductSkuImageRes>(Api.GET_PRODUCT_SKU_IMAGE, p)

/**
 * @description 查商品库存
 * @param p
 */
export  const getProductNewStockById = (p:GetProductNewStockByIdModel) => httpPost<GetProductNewStockByIdRes>(Api.GET_PRODUCT_NEW_STOCK_BY_ID,p)